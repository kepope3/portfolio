...
export default () => (
  <React.Fragment>
    <div id="about">
      <Section
        backgroundStyle={{
          backgroundImage: "linear-gradient(26deg, #bcb7b5, black)"
        }}
      >
        <h2>dqklwndl</h2>
        <p>
    ...
    <div id="portfolio">
      <Section
        backgroundStyle={{
          backgroundImage: "linear-gradient(90deg, #9b9795, black)"
        }}
      >
        <h2>dqklwndl</h2>
        <p>
    ...
    <div id="contact">
      <Section
        backgroundStyle={{
          backgroundImage: "linear-gradient(90deg, #7a7573, black)"
        }}
      >
        <h2>dqklwndl</h2>
        <p>
